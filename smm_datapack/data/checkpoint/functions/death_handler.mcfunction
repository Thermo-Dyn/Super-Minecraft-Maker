...
execute as @e[gamemode=!creative,gamemode=!spectator] run clear @a
scoreboard players set @a deathcount 0
execute as @e[gamemode=!creative,gamemode=!spectator] run item replace entity @a container.0 from block 0 2 5 container.0
